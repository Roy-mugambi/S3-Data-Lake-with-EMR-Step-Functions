...
# Load datasets
transactions = spark.read.csv("s3://roy-rental-apartment-project/rental_vehicles/rental_transactions.csv", header=True, inferSchema=True)
users = spark.read.csv("s3://roy-rental-apartment-project/rental_vehicles/users.csv", header=True, inferSchema=True)
